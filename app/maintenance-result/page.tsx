...
export default function ResultPage() {
  ...
  const raw = search.get('data'); // ?data=<url-encoded-json>
  if (!raw) {
    return (
      <main className="min-h-screen bg-gradient-to-br from-yellow-300 to-orange-500 flex items-center justify-center">
        <div className="bg-white/90 rounded-2xl p-8 shadow-lg text-center">
          <h1 className="text-2xl font-bold mb-2">Walang data!</h1>
  ...
  try {
    ...
    return (
      <main className="min-h-screen bg-gradient-to-br from-yellow-300 to-orange-500 flex items-center justify-center">
        <div className="bg-white/90 rounded-2xl p-8 shadow-lg text-center">
          <h1 className="text-2xl font-bold mb-2">Invalid data</h1>
          <Link href="/" className="inline-block bg-black text-yellow-300 px-4 py-2 rounded-lg hover:bg-gray-800 transition">
            Bumalik
          </Link>
        </div>
